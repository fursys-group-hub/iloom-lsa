...
const STATUS_MAP: Record<string, { label: string; color: string; bg: string; dot: string }> = {
  open: { label: '답변 대기', color: 'var(--orange)', bg: 'rgba(255,159,10,0.12)', dot: '🟠' },
  answered: { label: '답변 완료', color: 'var(--green)', bg: 'rgba(48,209,88,0.12)', dot: '🟢' },
};
const DEFAULT_STATUS = { label: '답변 완료', color: 'var(--text-muted)', bg: 'rgba(142,142,147,0.12)', dot: '⚪' };
